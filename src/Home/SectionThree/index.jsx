...
const SectionThree = () => {
  return (
    <>
      <Row className={`${styles.sectionbg} m-auto mb-5`}>
        <Row className="m-0 p-0">
          <Col>
            <h2 className="fw-bold textlight-gray mt-5 ps-5">
              Custom Furniture <br />
              Built Only For You
            </h2>
          </Col>
          <Col>
            <p className="textlight-gray mt-5  ps-5 pe-5">
        ...
        <Row className="m-0 p-0 mb-5">
          <Col lg={4} sm={6} className="mt-5">
            <div className={styles.visionbox}>
              ...
              <h4 className="textlight-gray text-center mt-2">Mission</h4>
              <p className={`${styles.boxtext} textlight-gray`}>
          ...
          <Col lg={4} sm={6} className="mt-5">
            <div className={styles.visionbox}>
              ...
              <h4 className="textlight-gray text-center mt-2">Vision</h4>
              <p className={`${styles.boxtext} textlight-gray`}>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                Voluptates, ea. Perferendis corrupti reiciendis nesciunt rerum
                velit autem unde numquam nisi
          ...
          <Col lg={4} sm={6} className="mt-5">
            <div className={styles.visionbox}>
              ...
              <h4 className="textlight-gray text-center mt-2">History</h4>
              <p className={`${styles.boxtext} textlight-gray`}>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                Voluptates, ea. Perferendis corrupti reiciendis nesciunt rerum
                velit autem unde numquam nisi
